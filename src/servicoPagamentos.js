...
export class servicoPagamento {
  ...
  realizarPagamento(codigo, empresa, valor, categoria = 'padrão') {
    if (valor > 100) {
      categoria = 'cara';
    }
...
// Caso de uso
let teste = new servicoPagamento();
teste.realizarPagamento('0987-7656-3475', 'Samar', 101);
console.log(teste.consultarUltimoPagamento());